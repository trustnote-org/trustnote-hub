INSERT INTO bots (name, description, pairing_code) VALUES (
	'Transition bot',
	'Allows you to link your Bitcoin and Trustnote addresses for participation in Trustnote distribution.',
	'A2WMb6JEIrMhxVk+I0gIIW1vmM3ToKoLkNF8TqUV5UvX@trustnote.org/tg#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	'Byte-BTC exchange',
	'Buy or sell Bytes for BTC instantly. Advanced users can offer their price, post pending orders and see the order book.',
	'Ar2ukVqx309sX+LoC9RVOpfATgXskt+Ser5jVr3Q2FOo@trustnote.org/tg#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	...
	'AuP4ngdv0S/rok+IaW1q2D6ye72eXLl3h+CqXNXzkBXn@trustnote.org/tg#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	'Sports oracle',
	...
	'Ar1O7dGgkkcABYNAbShlY2Pbx6LmUzoyRh6F14vM0vTZ@trustnote.org/tg#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	'BTC oracle',
	...
	'A7C96Bhg4Gpb2Upw/Ky/YfGG8BKe5DjTiBuJFGAX50N1@trustnote.org/tg#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	'Bounce bot',
	'Just for fun, send some of your bytes to the bot, and they will be bounced back to you. Developer: vakar.',
	'A6WUhxQX7bT1xY5UxoeL2/zNEgXGQXRO5ze4msXu3QrF@trustnote.com.ar/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	'Rosie bot',
...
Developer: Laurentiu-Andronache, https://github.com/Laurentiu-Andronache/trustnote-chatbot-Rosie',
	'ApOpqXbI7GpqOl3Z96QW/GSNgv04g4RcFr/xpaDmN9cg@trustnote.org/tg#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	'Trustnote Asset Manager',
	'Asset directory and asset creation platform for Trustnote. The chatbot provides a simple yet powerful interface to define and issue custom Trustnote assets. Assets behave similarly to the native currency "bytes": they are transferable and exchangeable. They can represent anything that has value such as debt, shares, loyalty points, airtime minutes, commodities, other fiat or crypto currencies.

Developer: Peter Miklos, https://trustnote.market',
	'Ao2SRelXb23nTnom+KHhLIzK4nyk0WAlE3vRWk5K25Gg@trustnote.org/tg#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	'Zork I game',
...
Source code: https://github.com/trustnote/flight-delays-insurance, fork and write your bot.',
	'Ai8b8CdBxZkm6h1RVhYT7y6Scas/eNn1ccavU7dgHYqN@trustnote.org/tg#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	'Poll bot',
	'Vote in polls.  The weight of your vote is proportional to your balance.

Source code: https://github.com/trustnote/poll-bot',
	'AhMVGrYMCoeOHUaR9v/CZzTC34kScUeA4OBkRCxnWQM+@trustnote.org/tg#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	...
	'AxV6ohKFORqIGfGqCZgjK1HlL8vBiNltcWWaI0Rc9yN+@trustnote.fr/bb#0000'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
	...
	'ApSicldzuDl675iiUyWdmO7pLl8MPgeuNg4qOr13EkNJ@trustnote.org/tg#globalchat'
);
INSERT INTO bots (name, description, pairing_code) VALUES (
...
Source code: https://github.com/trustnote/conditional-token-sale, you can use it to sell your tokens.',
	'AmXiHW7Ms4qcdmXeLW4U/ou5lv4HFnijYBGWGKfgT6bM@trustnote.org/tg#0000'
);
